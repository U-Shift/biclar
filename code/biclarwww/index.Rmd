...
DT::datatable(municipios_taburl,
                ...
                filter = 'none',
                rownames = FALSE,
                colnames = c("Município", "População 2021", "Total Viagens /dia 2018",
                             "Viagens Bicicleta 2018 até 5km", "Viagens Bicicleta 4% até 5km", "Viagens Bicicleta 10% até 5km", "Viagens Bicicleta 2018 até 10km e-bike", "Viagens Bicicleta 4% até 10km e-bike", "Viagens Bicicleta 10% até 10km e-bike","Viagens Bicicleta 2018 até 5km intermodal", "Viagens Bicicleta 4% até 5km intermodal", "Viagens Bicicleta 10% até 5km intermodal"),
                options = list(dom = "t",
                               pageLength = 18,
                               # width = "100%",
                               scrollX = TRUE,
