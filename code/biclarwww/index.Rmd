...
tabelas_aml = readRDS("D:/GIS/TML/biclar/HEAT/tabelas_aml.Rds")
...
*   Quais os impactes socioambientais previstos a médio e longo prazo (1 e 10 anos) em termos ambientais (CO~2~eq evitado), e sociais .

É também possível saber a informação agregada por [município](Municípios), para cada cenário escolhido, sobre todos os valores acima descritos.
