...
dontrun = !i %in% c("alcochete", "mafra", "montijo", "odivelas", "sesimbra") # não mostrar mapa 3
run = i %in% c("alcochete", "mafra", "montijo", "odivelas", "sesimbra") # mostrar mensagem mapa 3
