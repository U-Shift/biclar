...
Vendo o mapa em [ecrã inteiro](mapa_cenario1.html){target="_blank"} é possível comparar os resultados com a rede existente e planeada.
...
htmlwidgets::saveWidget(m3leaf_more, file = paste0("biclarwww/", i,"/mapa_cenario3.html"))
```


## Resumo

A tabela mostra o potencial ciclável `r stringr::str_to_lower(proposicao)` `r mun` em número de novas viagens em bicicleta potenciais diárias, para cada meta da Estratégia Nacional ENMAC (4% e 10%), para cada um dos três cenários, e para cada tipo de rotas otimizadas.  
