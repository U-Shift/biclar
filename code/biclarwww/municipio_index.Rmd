...
run = i %in% c("alcochete", "mafra", "montijo") # mostrar mensagem mapa 3
...
```{r conditional_block, echo=FALSE, results='asis', eval=run}
cat("

> Lamentamos, mas nesta área não existe rede ciclável potencial para o cenário 3, com as caraceterísticas definidas.")
```
