...
summary(routes_ferry4_filtered$distance) #75% less than 9000m in total
...
# 41k trips by bike
colnames(routes_ferry4_filtered)
...
sum(routes_ferry4_filtered$Bike) #21k
sum(routes_ferry4_filtered$cyc4) #166k
sum(routes_ferry4_filtered$new_cyc4) #149k
sum(routes_ferry4_filtered$cyc10) #415k
sum(routes_ferry4_filtered$new_cyc10) #396k


routes_ferry4_filtered[1,]
...
routes_ferry2_filtered = routes_r5r_100jit_lts2__ferry_elev %>%
  ...
  group_by(id) %>% 
  summarise(distance = distance)
summary(routes_ferry2_filtered$distance) #90% less than 9000m in total
routes_ferry2_filtered = routes_ferry2_filtered %>% filter(distance <= 9000)
...
# 36k trips by bike
colnames(routes_ferry2_filtered)
...
sum(routes_ferry2_filtered$Bike) #19k
sum(routes_ferry2_filtered$cyc4) #143k
sum(routes_ferry2_filtered$new_cyc4) #127k
sum(routes_ferry2_filtered$cyc10) #358k
sum(routes_ferry2_filtered$new_cyc10) #340k


routes_ferry2_filtered[1,]
