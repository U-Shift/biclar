...
library(biclar)
tm_rnet(rnet_ferry4_overline_morethan200_clean,
...
# saveRDS(rnet_ferry4_overline_morethan20_clean, "export/rnet_ferry4_overline_morethan20_clean.Rds")
# saveRDS(rnet_ferry4_overline_morethan200_clean, "export/rnet_ferry4_overline_morethan200_clean.Rds")
...
sum(routes_ferry3_filtered$cyc4) #102k
sum(routes_ferry3_filtered$new_cyc4) #91k
sum(routes_ferry3_filtered$cyc10) #256k
...
summary(rnet_ferry3_overline_morethan20$new_cyc4)
summary(rnet_ferry3_overline_morethan20$cyc4)
summary(rnet_ferry3_overline_morethan100$new_cyc4)
summary(rnet_ferry3_overline_morethan100$cyc4)
...
summary(rnet_ferry3_overline_morethan100_clean$group)

rnet_ferry3_overline_morethan100_group = rnet_ferry3_overline_morethan100_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_ferry3_overline_morethan100_group$count)
...
# summary(rnet_ferry3_overline_morethan20_clean$group)
# 
# rnet_ferry3_overline_morethan20_group = rnet_ferry3_overline_morethan20_clean %>%
#   st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
# summary(rnet_ferry3_overline_morethan20_group$count)
...
library(biclar)
tm_rnet(rnet_ferry3_overline_morethan20_clean,
        lwd = "cyc4", #Baseline, ENMAC4, ENMAC10
        # col = "Quietness",
        palette = "-linear_yl_rd_bk", # "linear_yl_rd_bk" "johnson", "mako", "burg", "reds" - reds for fastest, mako for quietest
        scale = 15,
...
saveRDS(rnet_ferry3_overline_morethan100_clean, "export/rnet_ferry3_overline_morethan100_clean.Rds")
# saveRDS(rnet_ferry3_overline_morethan20_clean, "export/rnet_ferry3_overline_morethan20_clean.Rds")
# rnet_ferry3_overline_morethan100_clean = readRDS("export/rnet_ferry3_overline_morethan100_clean.Rds")
...
rnet_ferry4_ebike_overline_morethan10 = rnet_ferry4_ebike_overline %>% filter(cyc4 >=10) #too much detail
rnet_ferry4_ebike_overline_morethan30 = rnet_ferry4_ebike_overline %>% filter(cyc4 >=30) #still too much detail
...
summary(rnet_ferry4_ebike_overline_morethan30$new_cyc4)
summary(rnet_ferry4_ebike_overline_morethan30$cyc4)
summary(rnet_ferry4_ebike_overline_morethan50$new_cyc4)
summary(rnet_ferry4_ebike_overline_morethan50$cyc4)
summary(rnet_ferry4_ebike_overline_morethan100$new_cyc4)
summary(rnet_ferry4_ebike_overline_morethan100$cyc4)
summary(rnet_ferry4_ebike_overline_morethan200$new_cyc4)
summary(rnet_ferry4_ebike_overline_morethan200$cyc4)
...
# summary(rnet_ferry4_ebike_overline_morethan50_clean$group)
# 
# rnet_ferry4_ebike_overline_morethan50_group = rnet_ferry4_ebike_overline_morethan50_clean %>%
#   st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
# summary(rnet_ferry4_ebike_overline_morethan50_group$count)
...
# # #rnet clean to get rid of small pieces - 30
# rnet_ferry4_ebike_overline_morethan30_clean = rnet_ferry4_ebike_overline_morethan30 %>%
#   mutate(group = stplanr::rnet_group(rnet_ferry4_ebike_overline_morethan30, d = 100 ))
# summary(rnet_ferry4_ebike_overline_morethan30_clean$group)
# 
# rnet_ferry4_ebike_overline_morethan30_group = rnet_ferry4_ebike_overline_morethan30_clean %>%
#   st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
# summary(rnet_ferry4_ebike_overline_morethan30_group$count)
# group = rnet_ferry4_ebike_overline_morethan30_group %>% filter(count >=5) #discard networks with less than 5 semnets?
# groupp = group$group
# 
# rnet_ferry4_ebike_overline_morethan30_clean = rnet_ferry4_ebike_overline_morethan30_clean %>%
#   filter(group %in% groupp) #more than 5 segments connected
# rm(rnet_ferry4_ebike_overline_morethan30_group)
...
summary(rnet_ferry4_ebike_overline_morethan400_clean$group)

rnet_ferry4_ebike_overline_morethan400_group = rnet_ferry4_ebike_overline_morethan400_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_ferry4_ebike_overline_morethan400_group$count)
...
saveRDS(rnet_ferry4_ebike_overline_morethan200_clean, "export/rnet_ferry4_ebike_overline_morethan200_clean.Rds")
saveRDS(rnet_ferry4_ebike_overline_morethan400_clean, "export/rnet_ferry4_ebike_overline_morethan400_clean.Rds")
# saveRDS(rnet_ferry4_ebike_overline_morethan50_clean, "export/rnet_ferry4_ebike_overline_morethan50_clean.Rds")
# saveRDS(rnet_ferry4_ebike_overline_morethan30_clean, "export/rnet_ferry4_ebike_overline_morethan30_clean.Rds")
# saveRDS(rnet_ferry4_ebike_overline_morethan10_clean, "export/rnet_ferry4_ebike_overline_morethan10_clean.Rds")
# rnet_ferry4_ebike_overline_morethan10_clean = readRDS("export/rnet_ferry4_ebike_overline_morethan10clean.Rds")
...
sum(routes_ferry3_ebike_filtered$cyc4) #157k
sum(routes_ferry3_ebike_filtered$new_cyc4) #140k
sum(routes_ferry3_ebike_filtered$cyc10) #392k
...
# rnet_ferry3_ebike_overline_morethan15 = rnet_ferry3_ebike_overline %>% filter(cyc4 >=15) #too much detail
# rnet_ferry3_ebike_overline_morethan30 = rnet_ferry3_ebike_overline %>% filter(cyc4 >=30) #still too much
# rnet_ferry3_ebike_overline_morethan40 = rnet_ferry3_ebike_overline %>% filter(cyc4 >=40) #still too much
...
summary(rnet_ferry3_ebike_overline_morethan50$new_cyc4)
summary(rnet_ferry3_ebike_overline_morethan50$cyc4)
summary(rnet_ferry3_ebike_overline_morethan100$new_cyc4)
summary(rnet_ferry3_ebike_overline_morethan100$cyc4)
summary(rnet_ferry3_ebike_overline_morethan200$new_cyc4)
summary(rnet_ferry3_ebike_overline_morethan200$cyc4)
...
summary(rnet_ferry3_ebike_overline_morethan100_clean$group)

rnet_ferry3_ebike_overline_morethan100_group = rnet_ferry3_ebike_overline_morethan100_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_ferry3_ebike_overline_morethan100_group$count)
...
# summary(rnet_ferry3_ebike_overline_morethan50_clean$group)
# 
# rnet_ferry3_ebike_overline_morethan50_group = rnet_ferry3_ebike_overline_morethan50_clean %>%
#   st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
# summary(rnet_ferry3_ebike_overline_morethan50_group$count)
...
summary(rnet_ferry3_ebike_overline_morethan200_clean$group)

rnet_ferry3_ebike_overline_morethan200_group = rnet_ferry3_ebike_overline_morethan200_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_ferry3_ebike_overline_morethan200_group$count)
...
saveRDS(rnet_ferry3_ebike_overline_morethan100_clean, "export/rnet_ferry3_ebike_overline_morethan100_clean.Rds")
saveRDS(rnet_ferry3_ebike_overline_morethan200_clean, "export/rnet_ferry3_ebike_overline_morethan200_clean.Rds")
# saveRDS(rnet_ferry3_ebike_overline_morethan50_clean, "export/rnet_ferry3_ebike_overline_morethan50_clean.Rds")
# rnet_ferry3_ebike_overline_morethan100_clean = readRDS("export/rnet_ferry3_ebike_overline_morethan100_clean.Rds")
...
sum(routes_allmodesNSub4_filtered$cyc4) #40k
sum(routes_allmodesNSub4_filtered$new_cyc4) #37k
...
summary(rnet_allmodesNSub4_overline_morethan10_clean$group)

rnet_allmodesNSub4_overline_morethan10_group = rnet_allmodesNSub4_overline_morethan10_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_allmodesNSub4_overline_morethan10_group$count)
...
saveRDS(rnet_allmodesNSub4_overline_morethan10_clean, "export/rnet_allmodesNSub4_overline_morethan10_clean.Rds")
...
summary(rnet_allmodesNSub4_overline_morethan50_clean$group)

rnet_allmodesNSub4_overline_morethan50_group = rnet_allmodesNSub4_overline_morethan50_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_allmodesNSub4_overline_morethan50_group$count)
...
saveRDS(rnet_allmodesNSub4_overline_morethan50_clean, "export/rnet_allmodesNSub4_overline_morethan50_clean.Rds")
...
routes_allmodesNSub3_dist = routes_allmodesNSub3_filtered %>%
  ...
  group_by(id) %>% 
  summarise(distance = sum(distance))
summary(routes_allmodesNSub3_filtered$distance) #75% less than 3600m in total
...
sum(routes_allmodesNSub3_filtered$cyc4) #43k
sum(routes_allmodesNSub3_filtered$new_cyc4) #40k
sum(routes_allmodesNSub3_filtered$cyc10) #107k
...
summary(rnet_allmodesNSub3_overline_morethan30_clean$group)

rnet_allmodesNSub3_overline_morethan30_group = rnet_allmodesNSub3_overline_morethan30_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_allmodesNSub3_overline_morethan30_group$count)
...
saveRDS(rnet_allmodesNSub3_overline_morethan30_clean, "export/rnet_allmodesNSub3_overline_morethan30_clean.Rds")
...
summary(rnet_allmodesNSub3_overline_morethan10_clean$group)

rnet_allmodesNSub3_overline_morethan10_group = rnet_allmodesNSub3_overline_morethan10_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_allmodesNSub3_overline_morethan10_group$count)
...
saveRDS(rnet_allmodesNSub3_overline_morethan10_clean, "export/rnet_allmodesNSub3_overline_morethan10_clean.Rds")
...
summary(rnet_allmodesNSub3_overline_morethan50_clean$group)

rnet_allmodesNSub3_overline_morethan50_group = rnet_allmodesNSub3_overline_morethan50_clean %>%
  st_drop_geometry() %>% group_by(group) %>% summarise(count = n())
summary(rnet_allmodesNSub3_overline_morethan50_group$count)
...
saveRDS(rnet_allmodesNSub3_overline_morethan50_clean, "export/rnet_allmodesNSub3_overline_morethan50_clean.Rds")
