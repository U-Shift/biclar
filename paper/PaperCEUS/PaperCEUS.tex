...
Leeds. 34-40 University Rd, Leeds LS2 9JT, UK}
  ...
  monetized. The results show that 10\% of trips could be made by
...
spatial distribution trip origins and destinations (Lovelace et al.,
...
centroid-based approach but does precisely capture the exactly spatial
...
application will help communicate decisions. Furthermore, the provision
of datasets resulting from this project provides a foundation for
further research and development of new tools and methods. The methods
are reproducible and based on open source software, which can be applied
to other cities and metropolitan areas, supporting the decarbonization
of transport systems internationally.
