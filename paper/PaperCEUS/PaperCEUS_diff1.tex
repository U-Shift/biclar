...
%DIF ADD paper/PaperCEUS/PaperCEUS_rev1.tex     Fri May  3 18:52:26 2024
...
\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \subfloat[In percentage\label{fig:mododist-1}]{\includegraphics[width=0.5\linewidth,]{PaperCEUS_prerev_files/figure-latex/mododist-1} }\subfloat[In total\label{fig:mododist-2}]{\includegraphics[width=0.5\linewidth,]{PaperCEUS_prerev_files/figure-latex/mododist-2} }%%%
\DIFdelendFL \DIFaddbeginFL \subfloat[In percentage\label{fig:mododist-1}]{\includegraphics[width=0.5\linewidth,]{PaperCEUS_rev1_files/figure-latex/mododist-1} }\subfloat[In total\label{fig:mododist-2}]{\includegraphics[width=0.5\linewidth,]{PaperCEUS_rev1_files/figure-latex/mododist-2} }\DIFaddendFL \caption{\label{mododist}Trips in the LMA by inter/intra municipal and mode, according to the travel survey.}\label{fig:mododist}
\end{figure}

\DIFdelbegin \DIFdel{To achieve the cycling targets set by the Portuguese }\DIFdelend \DIFaddbegin \DIFadd{The Portuguese Government has established a }\DIFaddend national cycling strategy\DIFdelbegin \DIFdel{for 2025 and 2030 (}\DIFdelend \DIFaddbegin \DIFadd{,
which outlines targets for the percentage of trips to be made by bicycle
in urban areas. Specifically, these targets aim for }\DIFaddend 4\% \DIFaddbegin \DIFadd{of all trips in
2025 }\DIFaddend and 10\% \DIFdelbegin \DIFdel{, respectively) \mbox{%DIFAUXCMD
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=1\linewidth,]{img/jitter_new} 
\DIFaddendFL 
...
the main PT interfaces in the LMA. \DIFaddbegin \DIFadd{It is noticeable the high potential
...
and/or docks from a bike sharing system. Additionally, they may need to
explore options to enhance bicycle carriage capacity on public transport
services, ensuring alignment with national targets.
}

\DIFadd{This analysis can be applied to other metropolitan areas, providing a
...
order to compare results with different areas. Nevertheless, the extent
of the potential shift from car to PT is highly dependent on the
distances typically travelled in such contexts, and the availability of
PT services - which can vary significantly between regions, and for
which we are not assuming any change in this study. This paper focus
primarily on the potential of making cycling and PT a viable alternative
to car trips, and the socio-environmental benefits of such a shift}\DIFaddend .
