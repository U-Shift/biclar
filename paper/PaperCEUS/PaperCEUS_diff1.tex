...
%DIF ADD paper/PaperCEUS/PaperCEUS_rev1.tex     Wed May  8 20:33:31 2024
...
\DIFdelbegin \DIFdel{methods used , it assesses }\DIFdelend \DIFaddbegin \hyperref[methods]{Methods} \DIFadd{used in Section 2, we assess }\DIFaddend its
...
\DIFadd{in Section 3, followed by Section 4 where we discuss the
...
paper in Section 5 with the main findings and policy implications}\DIFaddend .
