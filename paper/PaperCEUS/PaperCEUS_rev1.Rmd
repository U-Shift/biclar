...
```{r lma, fig.cap="\\label{lma}Population and daily trips (origins) at each Municipality of the LMA according to census and the travel survey.", fig.subcap=c("Population in the LMA","Trips/day in the LMA"), fig.ncol=2, message=FALSE, warning=FALSE, out.width="50%"}
...
cities = MUNICIPIOSgeo |> 
  filter(Concelho %in% c("Lisboa", "Sintra", "Cascais", "Loures", "Almada"))
...
## Modelling car shift to bicycle-PT - here or before??
...
The benefits are spatially unevenly distributed across the LMA, as shown in Figure \ref{fig:mapzones}.  
