...
```{r jitter, fig.align='center', fig.cap="Representation of a flow-weighted random sample of 10,000 desire lines in the Lisbon metropolitan area between districts, without jittering (left) and with jittering (right).", out.width="100%"}
...
knitr::include_graphics("img/jitter_rev.png", error = FALSE)
```
