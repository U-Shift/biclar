...
output: 
  rticles::elsevier_article:
    keep_tex: yes
    # citation_package: "default" #or none
...
# system("latexdiff PaperCEUS.tex PaperCEUS_rev1.tex > tracked_changes_rev1.tex")
# system("pdflatex tracked_changes_rev1.tex")
```
...
knitr::include_graphics("img/jitter_new.png", error = FALSE)
```
