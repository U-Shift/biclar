...
ENMAC10 = 0.10 # 10#
CAR_PT_TRANSF_mun_or_geo_18 = CAR_PT_TRANSF_mun_or_geo_18 |> 
  mutate(Bikeper = Bike / viagens) |>  #should it be "viagens" or "Total  -- all trips, not only the found ones
  mutate(Bike_new4 = ifelse(Bikeper >= ENMAC4*100, Bike, ENMAC4 * viagens),
         Bike_new10 = ifelse(Bikeper >= ENMAC10*100, Bike, ENMAC10 * viagens)) |> 
  mutate(Bike4 = ifelse(Bikeper >= ENMAC4*100, Bike, Bike + Bike_new4),
         Bike10 = ifelse(Bikeper >= ENMAC10*100, Bike, Bike + Bike_new10),
         Car_4 = ifelse(Bikeper >= ENMAC4*100, Car, Car - Bike_new4),
         Car_10 = ifelse(Bikeper >= ENMAC10*100, Car, Car - Bike_new10),
         TP_4 = TP + Bike_new4,
         TP_10 = TP + Bike_new10) |> 
