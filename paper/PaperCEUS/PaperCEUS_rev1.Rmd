...
After presenting the [Methods] used in Chapter 2, we assess its socio-environmental impacts using open data and open-source tools, presenting the [Results and Discussion] in Chapter 3, followed by Chapter 4 where we discuss the [Generalizability and Limitations] of the methods.
We [Conclude](#Conclusions) the paper in Chapter 5 with the main findings and policy implications.
