...
and a high demand for mobility (see Figure \ref{fig:lma}). As shown, the
number of trips is proportional to the population of each municipality,
with the highest number of trips originating in Lisbon, followed by the
municipalities of Sintra, Cascais, Loures, and Almada.
...
\begin{figure}
\subfloat[Population in the LMA\label{fig:lma-1}]{\includegraphics[width=0.5\linewidth,]{PaperCEUS_rev1_files/figure-latex/lma-1} }\subfloat[Trips/day in the LMA\label{fig:lma-2}]{\includegraphics[width=0.5\linewidth,]{PaperCEUS_rev1_files/figure-latex/lma-2} }\caption{\label{lma}Population and daily trips (origins) at each Municipality of the LMA according to census and the travel survey.}\label{fig:lma}
\end{figure}
