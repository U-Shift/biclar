...
population of 2.8 million residents The LMA is the most populous and
economically active region in Portugal, with the city of Lisbon as the
central node of the LMA, with a high concentration of jobs and services,
and a high demand for mobility (see Figure \ref{fig:lma}).
...
\begin{figure}
\subfloat[Population distribution in the LMA\label{fig:lma-1}]{\includegraphics[width=0.5\linewidth,]{PaperCEUS_rev1_files/figure-latex/lma-1} }\subfloat[Trips/day in the LMA\label{fig:lma-2}]{\includegraphics[width=0.5\linewidth,]{PaperCEUS_rev1_files/figure-latex/lma-2} }\caption{\label{lma}Population and daily trips (origins) at each Municipality of the LMA, according to census and the travel survey.}\label{fig:lma}
\end{figure}
...
from 3,000 to 7,500 tons per day. Moreover, for the second trip segment,
the shift from car to public transport contributes to avoiding up to
20,500 tons of CO\textsubscript{2}eq emissions annually. These changes
are estimated to yield socio-environmental benefits totaling €125
million to €325 million over a decade. The quantification of such
benefits can support policy-makers in prioritizing interventions to
reduce the reliance on private motorized modes of transportation.

Additionally, the results suggest that the potential for cycling-PT
intermodality is spatially unevenly distributed across the LMA, with the
highest potential in the municipalities with the highest number of trips
and PT interfaces of PT modes connecting to Lisbon and where it is
possible to carry bicycles on board, such as Lisbon, Sintra, Amadora,
and Almada.
...
generalization of the approach. We acknowledge the limitations of the
used methods and propose avenues for future research.
