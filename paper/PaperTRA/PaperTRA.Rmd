...
<!-- Robin: include here a paragraph about pct, and how biclar adds up -->
**(RL)** The methods of Propensity to Cycle Tool  
adding up an intermodality scenario to estimate cycling potential to public transit interfaces.
