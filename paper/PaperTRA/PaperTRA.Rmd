...
Table \ref{tab:summary1} presents the LMA total daily trips, the cycling combined with PT trips in the baseline scenario and corresponding potential trips to achieve the national strategy targets (4% and 10%), for different route profiles. 
...
knitr::kable(summary1,
      ...
      caption = "\\label{summary1old}Summary of the cycling potencial of intermodality scenario.",
      format="latex",
      booktabs = TRUE) |> 
...
This scenario unveils the potential of bicycles as a complementary mode of PT, with the prospective to uptake the number of PT trips within the LMA area by as much as 12% (in addition to the 825,000 reported in the mobility survey).
