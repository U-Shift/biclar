...
<!-- check the % of social impacts vs. environmental -->
...
The emissions of CO~2~eq that are avoided during both the initial and final journey segments account for about 75% of the emissions avoided during the PT segment. This finding, while expected -- due the zero cycling emissions, should not be overlooked when promoting the PT use. Improving the safe accessibility to PT interfaces to cyclists and providing bicycle-friendly amenities such as parking facilities can potentially lead to a higher reduction in CO~2~eq emissions, compared to a scenario where individuals shift from car travel to car + PT combination.

The social impacts from replacing car trips to bicycle in first-and-last legs, represent 95% of the total socio-environmental benefits estimated for all journey legs. <!-- sCheck the % of SOCIAL - original heat tables -->
