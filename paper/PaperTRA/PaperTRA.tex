...
cycling (up to 5 km on bike). Table \ref{tab:summary21} shows the PT
modes with most potential of in combination with cycling, by mode.
...
LMA area by as much as 6.3\% (in addition to the 825 thousand PT trips
