...
cycling (up to 5 km on bike). \emph{Table \ref{tab:summary21} shows
...
The social impacts from replacing car trips to bicycle in first-and-last
legs, represent 95\% of the total socio-environmental benefits estimated
for all journey legs. Our findings suggest that a bicycle and PT
combination could viably replace 20\% of current LMA trips, with an
additional 12\% of PT journeys prone to further substitution.
